                                    ...
                                    <div className="row">
                                        <div className="col">
                                                <div className="card border-0 shadow-sm rounded mt-3 bg-white pb-2" style={{padding:"10px", color:"#929b94"}}> 
                                                    <div className="row">
                                                        <div className="col-4">
                                                                <center><img src="/images/truck.png" className="img-fluid my-auto" style={{width:"70px"}}/></center>
                                                        </div>
                                                        <div className="col-8">
                                                                <h6 style={{color: "#1E90FF" }}>This month Income </h6> 
                                        ...
                                        <div className="col">
                                                <div className="card border-0 shadow-sm rounded mt-3 bg-white pb-2" style={{padding:"10px", color:"#929b94"}}> 
                                                    <div className="row">
                                                        ...
                                                        <div className="col-8">
                                                                <h6 style={{color: "#1E90FF" }}>Last month Income</h6> 
                                                                <h3>65,988.87 LKR</h3>
                                                        </div>
                                                    </div>
                                                </div>

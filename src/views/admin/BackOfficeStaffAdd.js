...
class BackOfficeStaffAdd extends Component {
    constructor(props) {
        super(props);
                        ...
                        <div className="row">
                            <div className="col-12">
                                <h5 className="text-dark bold-normal py-2 bg-white shadow-sm px-2 mt-3 rounded">
                                    Back Office Staff 
                                <span className="badge badge-success mx-2 ">Add Back Office Staff Member</span>
                                </h5>
                            </div>
                            <div className="col-12" >
                                    ...
                                    <div className="table-responsive px-2">
                                        <table className="table table-stripped">
                                            ...
                                            {this.filterByCategory().map((item) =>
                                                ...
                                                {/* {Users.map(item => this.displayAllManagers(item))} */}
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
    ...
    filterByCategory = () => {
        const { Users } = this.state;
        if (Users != null) {
          return Users.filter((p) => p.role == 'Back office');
        }
      };
...
export default withRouter(BackOfficeStaffAdd);
...
class WH_Sidebar extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
        ...
        >
            ...
            <div className="d-flex px-4">
              ...
              <div className="my-auto">
                                <h6 style={{lineHeight: '12px', fontWeight: 600}}
                                    className={`text-white mb-0 mt-1`}>Warehouse Staff </h6>
          ...
          <ul className="sidebar">
            ...
            <Link to="/backoffice/returnItemDashboard">
              <li
                className={`listitem ${ active == "add_products" && "active_category" }`}>
...
export default withRouter(WH_Sidebar);

                                ...
                                <div className="card border-0 shadow-sm rounded mt-3 bg-white pb-3 mb-5">
                                    ...
                                    <form className="py-1  px-3" method="POST">
                                        <div className="row">
                                            ...
                                            {/*---------Fax Number --------------  */}
                                             <div className="col-md-4 mt-2">
                                                <h6 className="form-label py-1">Fax Number</h6>
                                                <input
                                                    type="text"
                                                    style={{fontWeight: "bold"}}
                                                    name="brand"
                                            ...
                                            <div className="col-12">
                                                <h5 className="text-success bold-normal py-2 bg-white  px-2 mt-3 rounded">
                                                <br></br><br></br>
                                                <center>Enter Store Details</center>
                                                </h5>
                                            </div> 
                                                    ...
                                                    {/*---------Reg no--------------  */}
                                                    <div className="col-md-5 mt-2">
                                                        <h6 className="form-label py-1">Register No</h6>
                                                        <input
                                                            type="text"
                                                            style={{fontWeight: "bold"}}
                                                            name="price"
